...
urlpatterns = [
    ...
    # Inline AJAX actions for the single-page console
    ...
    path('admin/leads-dashboard/', admin_views.admin_console, name='admin_leads'),
    path('admin/campaigns-overview/', admin_views.admin_console, name='admin_campaigns'),
